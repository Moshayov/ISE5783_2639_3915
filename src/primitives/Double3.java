...
public class Double3 {
     ...
     * Two objects are considered equal if they are of the same class and their double values d1, d2, and d3 are equal
     * within a small margin of error defined by the {@link Util#isZero(double)} method.
     *
     ...
     * The hash code is generated by rounding the sum of the double values d1, d2, and d3 to the nearest integer.
     *
    ...
    /**
     * Returns a string representation of the object in the format "(d1,d2,d3)",
     * where d1, d2, and d3 are the values of the double components of the object.
     *
     * @return a string representation of the object in the format "(d1,d2,d3)"
     */
    @Override
