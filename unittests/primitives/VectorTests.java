...
class VectorTests {
    ...
    public void testDotProductEP() {
        ...
        assertEquals(-28d, v1.dotProdouct(v2), 0.00001, "dotProduct() wrong value");
    }
    ...
    void testCrossProduct() {
        ...
        assertTrue(isZero(vr.dotProdouct(v3)), "crossProduct() result is not orthogonal to 2nd operand");
