...
public class gitTest {
    ...
    private Scene setGeo() {
        ...
        scene1.getGeometries().add(new Cylinder(new Ray(new Point(75, 0, -50), new Vector(1, 1, 0)), 5d, 150d)
                .setEmission(new Color(66, 40, 11).reduce(2)).setMaterial(new Material().setKd(0.5).setKs(0.5).setnShines(300)));
        // sphere for hand
        ...
        scene1.getGeometries().add(new Cylinder(new Ray(new Point(175, 100, -50),
                ...
                reduce(2)).setMaterial(new Material().setKd(0.5).setKs(0.5).setnShines(300)));
        scene1.getGeometries().add(new Cylinder(new Ray(new Point(175, 100, -50),
                new Vector(-1, 1, 0)), 5d, 40d).setEmission(new Color(BLUE).reduce(2)).
                setMaterial(new Material().setKd(0.5).setKs(0.5).setnShines(300)));
        // left-hand
        ...
        scene1.getGeometries().add(new Sphere(new Point(-175, 100, -50), 20d).
                setEmission(new Color(BLUE).reduce(2)).setMaterial(new Material().setKd(0.5).setKs(0.5).setnShines(300)));
        // cylinders for fingers
        scene1.getGeometries().add(new Cylinder(new Ray(new Point(-175, 100, -50),
                new Vector(-1, 1, 0)), 5d, 40d).setEmission(new Color(BLUE).reduce(2)).
                setMaterial(new Material().setKd(0.5).setKs(0.5).setnShines(300)));
        ...
        scene1.getGeometries().add(new Triangle(new Point(-400, 301, 300), new Point(400, 301, 300),
                new Point(0, 500, 300)).setEmission(new Color(ORANGE)).setMaterial((new Material().setKd(0.5).setKs(0.5).setnShines(300).setKt(0.8))));
        scene1.getGeometries().add(new Triangle(new Point(-400, 301, -300), new Point(400, 301, -300),
                new Point(0, 500, -300)).setEmission(new Color(ORANGE)).setMaterial((new Material().setKd(0.5).setKs(0.5).setnShines(300).setKt(0.8))));
