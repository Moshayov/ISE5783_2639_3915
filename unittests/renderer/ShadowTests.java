...
public class ShadowTests {
    ...
    private Material trMaterial = new Material().setKd(0.5).setKs(0.5).setnShines(30);
    ...
    public void trianglesSphere() {
        Scene scene2 = new Scene.SceneBuilder("Test scene2").setAmbientLight(new AmbientLight(new Color(WHITE), 0.15)).build();


        scene2.getGeometries().add(
                new Triangle(new Point(-150, -150, -115), new Point(150, -150, -135),
                        new Point(75, 75, -150)) //
                        .setMaterial(new Material().setKs(0.8).setnShines(60)), //
