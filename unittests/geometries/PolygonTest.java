...
// ============ Equivalence Partitions Tests ==============
    ...
    void testFindIntersectionPoints() {
        ...
        List<Point> result = poly.findIntersectionPoints(new Ray(new Point(0,2, 0),
                new Vector(0,-1, 1)));
        ...
        result = poly.findIntersectionPoints(new Ray(new Point(0,2,0),
                new Vector(2,-1,1 )));
        ...
        result = poly.findIntersectionPoints(new Ray(new Point(0,2,1),
                new Vector(0,1, 1)));
        assertNull( result, "Ray's line out of polygon");
